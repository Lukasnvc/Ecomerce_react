...
console.log(cartItems)
  ...
  return (
    <Container>
      <Header>
        {cartItems.length ? <><h2>MY BAG</h2>
        <p>Reserved items for 60min</p> </> : <p>Your bag is empty</p>}
      ...
      <BtnContainer>
        {!!cartItems.length &&  <Button as={Link} to={isLoggedIn ? CHECKOUT_PATH :LOGIN_PATH}>Checkout</Button>}
